                ...
                <ul class="nav navbar-nav side-nav">
					...
					<li>
                        ...
                        <ul id="m" class="collapse">
                            <li>
                                <a href="../upload-download-files/spm.php"><i class="fa fa-fw fa-tag"></i>Surat Pengantar</a>
                            </li>
							<li>
                                <a href="buatspm.php"><i class="fa fa-fw fa-pencil"></i>Buat Surat Pengantar</a>
                            </li>
							<li>
...
<?php
		...
		if (isset($_POST['tblEdit'])){
			...
			if(empty($_POST['pass'])){
				...
				$kueri = mysql_query($sql);
				if ($kueri){
				echo "<script> alert('Password berhasil diubah');document.location='homesubbag.php'</script>";
			}
			else {
				echo "<script> alert('Pasword gagal diubah');document.location='homesubbag.php'</script>";
				echo mysql_error();
			}
				}
		} 
